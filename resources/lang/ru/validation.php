...
return [
    ...
    'custom' => [
        'date_of_birth' => [
            'before_or_equal' => 'Возраст должен быть не менее 16 лет.',
        ],
        'practice_started_at' => [
            'date_format' => 'Укажите год и месяц начала практики.',
            'before_or_equal' => 'Начало практики не может быть в будущем.',
            'after_or_equal' => 'Начало практики не может быть раньше чем через 16 лет после даты рождения.',
        ],
    ],

    'attributes' => [
        'practice_started_at' => 'начало практики',
        'name' => 'имя',
        'email' => 'электронная почта',
        'password' => 'пароль',
        'phone' => 'телефон',
    ],
    'throttle' => 'Слишком много попыток. Пожалуйста, подождите перед повторной отправкой.',
